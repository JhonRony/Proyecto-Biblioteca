...
<head>
    ...
    <title>Devolver Préstamo de Libro</title>
...
<body>
    <div class="container">
        <div class="card" style="width: 400px;">
            <div class="card-body">
                <h5 class="card-title text-center">DEVOLVER PRÉSTAMO DE LIBRO</h5>
                <?php
                ...
                ?>
                        <form action="../controller/confirmar_devolucion_controller.php" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="carrera" class="form-label">Seccion del Alumno</label>
                                <input type="text" class="form-control" id="carrera" name="carrera" value="<?php echo $fila['NombreCarrera']; ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="fecha_prestamo" class="form-label">Fecha de Préstamo</label>
                                <input type="text" class="form-control" id="fecha_prestamo" name="fecha_prestamo" value="<?php echo $fila['Fecha_Prestamo']; ?>" readonly>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-danger">Confirmar Devolución</button>
                                <a href="../views/prestar_libros.php" class="btn btn-primary">Cancelar</a>
                            </div>
                        </form>
                <?php
                    } else {
